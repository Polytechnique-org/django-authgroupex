...
class AuthGroupeXBackendTestCase(TestCase):
    ...
    def testCreateNewUser(self):
        ...
        auth_data = {
            'username': 'jean.dupond.1985',
            'firstname': "Jean",
            'lastname': "Dupond",
            'promo': 1985,
            'email': 'jean.dupond@polytechnique.org'
        }
        ...
        user_from_db = User.objects.get(username='jean.dupond.1985')
        ...
        self.assertEqual(user.email, 'jean.dupond@polytechnique.org')

    def testComingBack(self):
